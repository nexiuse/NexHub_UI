...
local NotifyFactory = loadstring(game:HttpGet("local NotifyFactory = loadstring(game:HttpGet("https://raw.githubusercontent.com/nexiuse/NexHub_UI/main/Fixed_Notify.lua"))()
"))()
